...
# 	private m_BackgroundStyle as GUIStyle = new GUIStyle() 		# Style for background tiling
# 	private m_FadeTexture	as Texture2D			# 1x1 pixel texture used for fading
# 	private m_CurrentScreenOverlayColor as Color = new Color(0,0,0,0) 	# default starting color: black and fully transparrent
# 	private m_TargetScreenOverlayColor as Color= new Color(0,0,0,0) # default target color: black and fully transparrent
# 	private m_DeltaColor as Color = new Color(0,0,0,0) 		# the delta-color is basically the "speed / second" at which the current color should change
# 	private m_FadeGUIDepth as single = -1000 				# make sure this texture is drawn on top of everything
...
# 	def SetScreenOverlayColor(Color newScreenOverlayColor):
...
# 	def StartFade(Color newScreenOverlayColor, float fadeDuration):
